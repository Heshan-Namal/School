...
<div class="container_AssStudent">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$a->count}}</td>
                        <td><a href="{{route('submit.view',[$a->id])}}"><button
                                    class="btn btn-primary btn-sm">View</button></a> </td>
    ...
    <form action="@chart('result_ass_chart')?classid={{$classid}}&subjectid={{$subjectid}}" method="GET">
