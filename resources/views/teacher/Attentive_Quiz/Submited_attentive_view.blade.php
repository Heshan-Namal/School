...
@section('content')
    ...
    <div class="container_AssStudent">
        <div class="row d-flex justify-content-evenly mb-5">
                ...
                <div class="sub-card">
                    <div class="row g-0">
                        <div class="col-md-4 mt-3">
                            <img src="{{ asset('assets/front/images/ass/a1.png') }}" alt="Trendy Pants and Shoes"
            ...
            <div class="col-3">
                <div class="sub-card">
                    <div class="row g-0">
                        <div class="col-md-4 mt-3">
                            <img src="{{ asset('assets/front/images/ass/a2.png') }}" alt="Trendy Pants and Shoes"
                                class="img-fluid rounded-start d-flex mx-2" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text pb-1">
                                    Percentage of total Responses on today
                                </p>
                                <h2 class="card-title fw-bold d-flex justify-content-end pe-3">
                                    @if ($std != 0 && $count != 0)
            ...
            <div class="col-3">
                <div class="sub-card">
                    <div class="row g-0">
                        <div class="col-md-4 mt-3">
                            <img src="{{ asset('assets/front/images/ass/a3.png') }}" alt="Trendy Pants and Shoes"
                                class="img-fluid rounded-start d-flex mx-2" />
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <p class="card-text pb-1">
                                    Percentage of total Results on today
                                </p>
                                <h2 class="card-title fw-bold d-flex justify-content-end pe-3">
                                    @if ($std != 0 && $count != 0)
                                ...
                                @foreach ($quizes as $key => $q)
                                    <tr>
                                        ...
                                        @else
                                            <td>None</td>
                                        @endif
                                        <td><a href="{{ route('attentive-submit', [$q->id]) }}"><button type="button"
                                                    class="btn btn-primary rounded-pill mx-3">View</button></a>
                    </div>
                    </td>
                    </tr>
                @endforeach
        ...
        <div class="row mt-3 mb-4">
            <div class="col-6 ">
                <h4 class="timetable mt-4 text-center">Current Month Attentive checks that you include Summary as Percentage
                </h4>
            </div>
            <div class="col-6">
        ...
        {{-- <div class="row mt-3 mb-4">
            <div class="col-6 ">
                <h4 class="timetable mt-4 text-center">Current Month Attentive checks Student</h4>
            </div>
            <div class="col-6">
