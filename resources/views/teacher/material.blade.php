        ...
        <div class="col-sm-3">
            <div class="card">
                <a href="{{route('quiz.index',[$classid,$subjectid])}}" style="text-decoration:none;">
                    <div class="card-body">
                        <img src="{{asset('assets/front/images/ass/quiz-q.png')}}" class="rounded mx-auto d-block"
                            alt="...">
        ...
        <div class="col-sm-3">
            <div class="card">
                <a href="{{route('res.index',[$classid,$subjectid])}}" style="text-decoration:none;">
                    <div class="card-body">
                        <img src="{{asset('assets/front/images/ass/notebook.png')}}" class="rounded mx-auto d-block"
                            alt="...">
        ...
        <div class="col-sm-3">
            <div class="card">
                <a href="#" style="text-decoration:none;">
                    <div class="card-body">
                        <img src="{{asset('assets/front/images/ass/time.jpg')}}" class="rounded mx-auto d-block"
                            alt="...">
        ...
        <div class="col-sm-3">
            <div class="card">
                <a href="{{route('class.recordbook',[$classid,$subjectid])}}" style="text-decoration:none;">
                    <div class="card-body">
                        <img src="{{asset('assets/front/images/ass/recbook.png')}}" class="rounded mx-auto d-block"
                            alt="...">
