...
<div class='content'>
                                    ...
                                    <table class="table table-primary table-hover table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->due_date}}</td>
                                                <td><a href="{{route('Student.student.showQuiz',$item->id)}}"
                                    ...
                                    <table class="table table-primary table-hover table-striped ">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->description}}</td>
                                                <td>{{$item->due_date}}</td>
                                                <td><a href="http://127.0.0.1:8000/assignments/{{$item->assessment_file}}"
                                                        target="_blank">{{$item->assessment_file}}</a></td>
                                                <td><a href="{{route('Student.student.uploadHomework',[$item->class_id,$item->subject_id,$item->id])}}"
                                                        target="_blank"><button type="button"
                                                            class="btn btn-primary">View</button></a></td>
                                            </tr>
                                            @endforeach
    ...
    for (var i = 0; i < divs.length; i++) {
        ...
        switch (s) {
            case "science":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/science.png')}}')";
            ...
            case "english":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/english.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 75%";
                break;
            ...
            case "maths":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/maths2.png')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 75%";
                break;
            ...
            case "history":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/history.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
            ...
            case "sinhala":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/sinhala.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 75%";
                break;
            ...
            case "buddhism":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/buddhism.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
            ...
            case "art":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/art.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 75%";
                break;
            ...
            case "ict":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/ict.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
            ...
            case "tamil":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/tamil.png')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 75%";
                break;
            ...
            case "health":
                divs[i].children[0].style.backgroundImage =
                    "url('{{asset('assets/front/images/student_img/health.jpg')}}')";
                divs[i].children[0].style.backgroundPosition = "50% 10%";
                divs[i].children[0].style.backgroundRepeat = "no-repeat";
                divs[i].children[0].style.backgroundSize = "80% 85%";
                break;
