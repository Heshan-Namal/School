...
<div class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title fw-bold text-capitalize"> Grade {{$item->grade_name}}</h2>
        ...
        <div class="col-sm-3">
            <div class="card card-pointer">
                <div class="card-body mt-3" data-bs-toggle="modal" data-bs-target="#AddGradeModal">
                    <img src="{{asset('assets/front/images/icons/plus.png')}}" class="rounded mx-auto d-block"
                        alt="...">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i
                                            class="material-icons me-3" data-toggle="tooltip"
                                            title="Edit">&#xE254;</i></a>
