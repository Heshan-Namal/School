                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editmodal"
                            data-bs-subjectid="{{$s->subjectid}}" data-bs-file="{{$sub[$s->subjectid]}}">EDIT</button>
                        @else
                        <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#createmodal"
                            data-bs-subjectid="{{$s->subjectid}}">ADD</button>
                        <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#editmodal"
            ...
            <div class="modal-body table">
                <form action="{{route('attendance.store')}}" method="POST" enctype="multipart/form-data">@csrf
                    ...
                    <div class="form-group mb-4" id="file">
                        ...
                        <input type="file" class="form-control" @error('attendance_file') is-invalid @enderror
...
<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="example1ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body table">
                <form action="{{route('update.attendance')}}" method="POST" enctype="multipart/form-data">
                    @method('PUT') @csrf
                    <div class="form-group mb-4">
                        <input type="hidden" class="form-control " name="class_id" value="{{$dd->id}}">
                    </div>
