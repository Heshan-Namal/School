    ...
    <div class="row  d-flex justify-content-end ">
        <div class="col-4">
            <div class="box-card">
                <div class="row g-0">
                    <div class="col-md-4 ">
                        <img src="{{asset('assets/front/images/ass/s.png')}}" alt="Trendy Pants and Shoes"
        ...
        <table class="table table-success table-hover mt-2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="{{route('myclass.studentview',[$s->admission_no])}}"><button
                                class="btn btn-primary btn-sm"><i class="bi bi-binoculars-fill"></i></button></a> </td>
                </tr>
